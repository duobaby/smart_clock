...
void ui_HomePage_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_BaticonLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_BatNumLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_StepiconLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_StepCnLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_TempiconLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_HumiiconLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_HRiconLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_NFCLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_BLELabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_SetLabel, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_PowerPage_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_PowerDownLabel, &lv_font_montserrat_18, LV_PART_MAIN | LV_STATE_DEFAULT);
